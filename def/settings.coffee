...
localizeInstall = () ->
  ...
  si = setInterval((->
    pref.find('.section-heading.icon.icon-cloud-download:contains("Install Packages")').html('新增擴充套件')
    pref.find('.section-heading.icon.icon-cloud-download:contains("Install Themes")').html('新增佈景主題')
